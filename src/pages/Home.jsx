export default function Home() {
  return (
    <section className="">
        ...
        <div className="w-full fixed bg-black flex justify-center items-center mb-24 lg:ps-1 gap-28 py-1z">
            <img src="/logo-site.jpg" alt="Imagem de um boi feito por listras" className="w-20"/>
            <div className="max-lg:hidden flex gap-28 font-osw uppercase font-normal">
        ...
        <div className="bg-[url('/carne-fundo.jpg')] bg-cover bg-center h-56 flex justify-center items-center lg:h-80">
          <h1 className="font-porter text-6xl text-center lg:text-8xl">Dry Ager</h1>
        </div>

        <div className="bg-gray p-9 text-white font-light text-xl text-justify lg:px-44 lg:py-20">
          <div className="mb-8">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between">
            <button className="bg-green py-6 rounded-xl mb-6 lg:mb-0 lg:w-60"><a href="https://wa.me/5511989859243">Faça já seu pedido</a></button>
            
            <button className="bg-blue py-6 rounded-xl lg:w-60"><a href="/Produto">Saiba mais</a></button>
          </div>
        </div>
    </section>
  )
